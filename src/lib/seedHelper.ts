...
export async function ensureRestaurantSeeded(requestedSlug?: string) {
  ...
  // 1. Tentar buscar o restaurante no banco de dados real com todas as categorias e itens
  ...
  // 2. Se não existir no banco de dados real, criar e popular a base relacional pela primeira vez
  if (!restaurant) {
    ...
    // Refetch completo do banco real
