...
import { Store, Utensils, Clock, CheckCircle, AlertCircle, RefreshCw, Phone, MapPin } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-zinc-900 border border-zinc-800 p-5 rounded-3xl">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-1">
              Acompanhe pedidos em tempo real e altere a disponibilidade do restaurante.
            </p>
          </div>
